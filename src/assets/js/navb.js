var navb='<ul>'+
          ...
          '<li class="drop-down" style="padding-left:5px; padding-right: 5px;""><a href="/living_lab">Living Lab</a>'+
            '<ul>'+
              ...
              '<li ><a href="/living_lab/projects" class="unfinished" >Projects</a></li>'+
            '</ul>'+
          '</li>'+
          '<li class="drop-down" style=" padding-left:5px; padding-right: 5px;""><a href="/innovation">Innovation</a>'+
            ...
            '</ul>'+
          '</li>'+
          '<li style=" padding-left:5px; padding-right: 5px;""><a href="/partners">Partners</a></li>'+
...
'<li><i class="icofont-twitter"></i><a href="https://twitter.com/'+twitterid+'">'+twitterid+'</a></li>'+'<li><i class="icofont-linkedin"></i><a href="https://linkedin.com/company/'+linkedinid+'"> smartcity living lab</a></li>'
...
var foot_focusarea='<h4>Resources</h4>'+
      ...
      '<li><i class="bx bx-chevron-right"></i><a href="/resources/rnd">R &amp D ShowCase</a></li>'+
                  ...
                  // '<li><i class="bx bx-chevron-right"></i><a href="/resources/podcast">Podcasts</a></li>'+
...
var contact_us='<h4>Contact Us</h4>'+
            '<p style="text-align: left;">'+
              ...
              '<strong>Linkedin:</strong> '+linkedinid+'<br>'+
            '</p>';
